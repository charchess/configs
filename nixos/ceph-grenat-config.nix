...
'';
  ...
  systemd.services.ceph-mon = {
    ...
    serviceConfig = {
      ...
      User = "ceph";
      Group = "ceph";
      ExecStart = "${pkgs.ceph}/bin/ceph-mon --cluster ceph --id grenat --public-addr 192.168.111.64";
      ExecReload = "${pkgs.ceph}/bin/ceph-mon --cluster ceph --id grenat --public-addr 192.168.111.64 --reload";
      Restart = "always";
      RestartSec = 10;
    };
  };
  ...
  systemd.services.ceph-mgr = {
    ...
    serviceConfig = {
      ...
      User = "ceph";
      Group = "ceph";
      ExecStart = "${pkgs.ceph}/bin/ceph-mgr --cluster ceph --id grenat";
      ExecReload = "${pkgs.ceph}/bin/ceph-mgr --cluster ceph --id grenat --reload";
      Restart = "always";
      RestartSec = 10;
    };
  };
