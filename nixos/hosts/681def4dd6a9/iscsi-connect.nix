...
{
  environment.etc."iscsi/nodes/iqn.2000-01.com.synology:Synelia.Target-emy/192.168.111.69,3260,1/default" = {
    # NixOS va créer le chemin de répertoires nécessaire
    # et écrire le contenu ci-dessous dans un fichier nommé "default"
    text = ''
      node.name = iqn.2000-01.com.synology:Synelia.Target-emy
      node.targetname = iqn.2000-01.com.synology:Synelia.Target-emy
  ...
  services.openiscsi = {
    ...
    name = "iqn.1993-08.org.debian:01:1e46c63dd1-emy";
  };
